...
#ifndef CL_EXT_PREFIX__VERSION_1_2_DEPRECATED
...
#define CL_COMMAND_MIGRATE_SVM_MEM_OBJECTS          0x120E
...
#define CL_PROFILING_COMMAND_COMPLETE               0x1284
	...
	typedef cl_int CL_API_CALL
		__clRetainDevice(cl_device_id /* device */) CL_API_SUFFIX__VERSION_1_2;

	typedef cl_int CL_API_CALL
		__clReleaseDevice(cl_device_id /* device */) CL_API_SUFFIX__VERSION_1_2;

	typedef cl_int CL_API_CALL
		__clSetDefaultDeviceCommandQueue(cl_context           /* context */,
			cl_device_id         /* device */,
			cl_command_queue     /* command_queue */);

	typedef cl_int CL_API_CALL
		__clGetDeviceAndHostTimer(cl_device_id    /* device */,
			cl_ulong*       /* device_timestamp */,
			cl_ulong*       /* host_timestamp */);

	typedef cl_int CL_API_CALL
		__clGetHostTimer(cl_device_id /* device */,
			cl_ulong *   /* host_timestamp */) ;
	...
	typedef cl_mem CL_API_CALL
		__clCreatePipe(cl_context                 /* context */,
			cl_mem_flags               /* flags */,
	...
	typedef void * CL_API_CALL
		__clSVMAlloc(cl_context       /* context */,
			cl_svm_mem_flags /* flags */,
			size_t           /* size */,
			cl_uint          /* alignment */);

	typedef void CL_API_CALL
		__clSVMFree(cl_context        /* context */,
			void *            /* svm_pointer */);

	/* Sampler APIs */
	typedef cl_sampler CL_API_CALL
		__clCreateSamplerWithProperties(cl_context                     /* context */,
	...
	typedef cl_program CL_API_CALL
		__clCreateProgramWithIL(cl_context    /* context */,
			const void*    /* il */,
			size_t         /* length */,
			cl_int*        /* errcode_ret */);
	...
	typedef cl_int CL_API_CALL
		__clUnloadPlatformCompiler(cl_platform_id /* platform */) CL_API_SUFFIX__VERSION_1_2;
	...
	typedef cl_kernel CL_API_CALL
		__clCloneKernel(cl_kernel     /* source_kernel */,
			cl_int*       /* errcode_ret */);
	...
	typedef cl_int CL_API_CALL
		__clSetKernelArgSVMPointer(cl_kernel    /* kernel */,
			cl_uint      /* arg_index */,
			const void * /* arg_value */);

	typedef cl_int CL_API_CALL
		__clSetKernelExecInfo(cl_kernel            /* kernel */,
	...
	typedef cl_int CL_API_CALL
		__clGetKernelSubGroupInfo(cl_kernel                   /* kernel */,
			cl_device_id                /* device */,
	...
	typedef cl_int CL_API_CALL
		__clEnqueueSVMFree(cl_command_queue  /* command_queue */,
	...
	typedef cl_int CL_API_CALL
		__clEnqueueSVMMemcpy(cl_command_queue  /* command_queue */,
	...
	typedef cl_int CL_API_CALL
		__clEnqueueSVMMemFill(cl_command_queue  /* command_queue */,
			void *            /* svm_ptr */,
			const void *      /* pattern */,
			size_t            /* pattern_size */,
			size_t            /* size */,
	...
	typedef cl_int CL_API_CALL
		__clEnqueueSVMMap(cl_command_queue  /* command_queue */,
			cl_bool           /* blocking_map */,
			cl_map_flags      /* flags */,
			void *            /* svm_ptr */,
			size_t            /* size */,
	...
	typedef cl_int CL_API_CALL
		__clEnqueueSVMUnmap(cl_command_queue  /* command_queue */,
			void *            /* svm_ptr */,
			cl_uint           /* num_events_in_wait_list */,
			const cl_event *  /* event_wait_list */,
			cl_event *        /* event */);
	...
	typedef cl_int CL_API_CALL
		__clEnqueueSVMMigrateMem(cl_command_queue         /* command_queue */,
			cl_uint                  /* num_svm_pointers */,
	...
	*/
	...
	typedef CL_EXT_PREFIX__VERSION_1_1_DEPRECATED cl_mem CL_API_CALL
	...
	typedef CL_EXT_PREFIX__VERSION_1_1_DEPRECATED cl_int CL_API_CALL
	...
	typedef CL_EXT_PREFIX__VERSION_1_1_DEPRECATED cl_int CL_API_CALL
		__clEnqueueBarrier(cl_command_queue /* command_queue */) CL_EXT_SUFFIX__VERSION_1_1_DEPRECATED;

	typedef CL_EXT_PREFIX__VERSION_1_1_DEPRECATED cl_int CL_API_CALL
		__clUnloadCompiler(void) CL_EXT_SUFFIX__VERSION_1_1_DEPRECATED;

	typedef CL_EXT_PREFIX__VERSION_1_1_DEPRECATED void * CL_API_CALL
		__clGetExtensionFunctionAddress(const char * /* func_name */) CL_EXT_SUFFIX__VERSION_1_1_DEPRECATED;

	/* Deprecated OpenCL 2.0 APIs */
	typedef CL_EXT_PREFIX__VERSION_1_2_DEPRECATED cl_command_queue CL_API_CALL
	...
	typedef CL_EXT_PREFIX__VERSION_1_2_DEPRECATED cl_sampler CL_API_CALL
	...
	typedef CL_EXT_PREFIX__VERSION_1_2_DEPRECATED cl_int CL_API_CALL
	...
	extern __clCreateSubDevices *clCreateSubDevices;
	extern __clRetainDevice *clRetainDevice;
	extern __clReleaseDevice *clReleaseDevice;
	...
	extern __clCreateSubBuffer *clCreateSubBuffer;
	extern __clCreateImage *clCreateImage;
	...
	extern __clSetMemObjectDestructorCallback *clSetMemObjectDestructorCallback;
	...
	extern __clCreateProgramWithBuiltInKernels *clCreateProgramWithBuiltInKernels;
	extern __clRetainProgram *clRetainProgram;
	extern __clReleaseProgram *clReleaseProgram;
	extern __clBuildProgram *clBuildProgram;
	extern __clCompileProgram *clCompileProgram;
	extern __clLinkProgram *clLinkProgram;
	extern __clUnloadPlatformCompiler *clUnloadPlatformCompiler;
	...
	extern __clGetKernelArgInfo *clGetKernelArgInfo;
	...
	extern __clCreateUserEvent *clCreateUserEvent;
	extern __clRetainEvent *clRetainEvent;
	extern __clReleaseEvent *clReleaseEvent;
	extern __clSetUserEventStatus *clSetUserEventStatus;
	extern __clSetEventCallback *clSetEventCallback;
	...
	extern __clEnqueueWriteBufferRect *clEnqueueWriteBufferRect;
	extern __clEnqueueFillBuffer *clEnqueueFillBuffer;
	extern __clEnqueueCopyBuffer *clEnqueueCopyBuffer;
	extern __clEnqueueCopyBufferRect *clEnqueueCopyBufferRect;
	extern __clEnqueueReadImage *clEnqueueReadImage;
	extern __clEnqueueWriteImage *clEnqueueWriteImage;
	extern __clEnqueueFillImage *clEnqueueFillImage;
	...
	extern __clEnqueueMigrateMemObjects *clEnqueueMigrateMemObjects;
	extern __clEnqueueNDRangeKernel *clEnqueueNDRangeKernel;
	extern __clEnqueueNativeKernel *clEnqueueNativeKernel;
	extern __clEnqueueMarkerWithWaitList *clEnqueueMarkerWithWaitList;
	extern __clEnqueueBarrierWithWaitList *clEnqueueBarrierWithWaitList;
	extern __clGetExtensionFunctionAddressForPlatform *clGetExtensionFunctionAddressForPlatform;
...
// version 2.0
	extern __clCreateCommandQueueWithProperties *clCreateCommandQueueWithProperties;
	extern __clCreatePipe *clCreatePipe;
	extern __clGetPipeInfo *clGetPipeInfo;
	extern __clSVMAlloc *clSVMAlloc;
	extern __clSVMFree *clSVMFree;
	extern __clCreateSamplerWithProperties *clCreateSamplerWithProperties;
	extern __clSetKernelArgSVMPointer *clSetKernelArgSVMPointer;
	extern __clSetKernelExecInfo *clSetKernelExecInfo;
	extern __clEnqueueSVMFree *clEnqueueSVMFree;
	extern __clEnqueueSVMMemcpy *clEnqueueSVMMemcpy;
	extern __clEnqueueSVMMemFill *clEnqueueSVMMemFill;
	extern __clEnqueueSVMMap *clEnqueueSVMMap;
	extern __clEnqueueSVMUnmap *clEnqueueSVMUnmap;

// version 2.1
	extern __clSetDefaultDeviceCommandQueue *clSetDefaultDeviceCommandQueue;
	extern __clGetDeviceAndHostTimer *clGetDeviceAndHostTimer;
	extern __clGetHostTimer *clGetHostTimer;
	extern __clCreateProgramWithIL *clCreateProgramWithIL;
	extern __clCloneKernel *clCloneKernel;
	extern __clGetKernelSubGroupInfo *clGetKernelSubGroupInfo;
	extern __clEnqueueSVMMigrateMem *clEnqueueSVMMigrateMem;
	...
	extern cl_int clLibLoad(int version = 12);
